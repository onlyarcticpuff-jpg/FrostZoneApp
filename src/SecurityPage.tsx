// SecurityPage.tsx
// Requires: otplib, qrcode, react-pin-input
// npm install otplib qrcode react-pin-input
...
// @ts-ignore — react-pin-input has no bundled types
            ...
            {step === "create" && (
              <div style={pinWrapStyle}>
                <PinInput
                  ...
                  inputFocusStyle={pinInputFocusStyle}
                  autoSelect
                />
              </div>
            )}
...
const pinInputFocusStyle: React.CSSProperties = {
  border: "1.5px solid rgba(42,171,238,0.65)",
  background: "rgba(42,171,238,0.08)",
  boxShadow: "0 0 0 3px rgba(42,171,238,0.12)",
};
