...
function WalletModal({ mode, onClose, tonAddress }: {
  mode: WalletMode;
  onClose: () => void;
  tonAddress: string;
}) {
  ...
  const handleSubmit = () => {
    // TODO: wire to actual TON / Telegram Stars payment
    setStep("done");
        ...
        {step === "done" ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center",
            ...
            <div style={{ fontSize: 18, fontWeight: 800, color: "#fff", letterSpacing: "-0.5px" }}>
              {isDeposit ? "Deposit Initiated!" : "Withdrawal Submitted!"}
            </div>
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.40)", textAlign: "center", lineHeight: 1.6 }}>
              {isDeposit
                ? "Your funds will appear in your balance shortly."
...
function ProfilePage({ tonAddress }: { tonAddress: string }) {
  ...
  // Mock balances — replace with real Supabase/chain data
