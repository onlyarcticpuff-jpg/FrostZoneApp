  ...
  return (
    ...
    >
      <div style={{ borderRadius: 18, overflow: "hidden", position: "relative", aspectRatio: "3 / 4",
        ...
        <div style={{ position: "absolute", top: 9, right: 9, zIndex: 3,
          ...
          padding: "3px 9px 3px 6px", fontSize: 12, fontWeight: 700, color: "#fff", letterSpacing: "-0.1px" }}>
          {item.currency === "TON"
  ...
  return (
    <div className="app">
      <style>{`
        *, *::before, *::after {
        ...
        .logo-wrap {
          ...
          height: 42px; padding: 0 11px; border-radius: 14px;
          background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.11);
          box-shadow: 0 2px 16px rgba(0,0,0,0.30), 0 1px 0 rgba(255,255,255,0.08) inset;
        }
        .brand-logo { height: 26px; width: auto; object-fit: contain; display: block; }
      ...
      <div className="container">
        ...
        {/* ── Other tabs ── */}
        {activeTab !== "home" && activeTab !== "inventory" && activeTab !== "profile" && (
