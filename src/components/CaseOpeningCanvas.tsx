...
export default function CaseOpeningCanvas({
  ...
  return (
    // Outer: block-level, fills whatever width the parent gives, fixed height
    // Change the height value here to resize the whole canvas in your layout
    <div
      style={{
        position: "relative",
        width: "100%",
        height: "220px",        // ← single source of truth for canvas height
        overflow: "hidden",
        borderRadius: 12,
        backgroundColor: "#0b0d12", // prevents flash before pixi mounts
      }}
    >
      {/* Inner: the actual PixiJS mount target — fills the outer absolutely */}
      <div
        ref={hostRef}
        style={{
          position: "absolute",
