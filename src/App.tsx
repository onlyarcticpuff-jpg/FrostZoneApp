...
/* ─── TONAPI NFT collections ─────────────────────────────────────
   TONAPI exposes a REST API (not GraphQL).
   Key is sourced from VITE_TONAPI_KEY (or REACT_APP_TONAPI_KEY).
   Endpoint: GET https://tonapi.io/v2/nfts/collections?limit=6
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const r = await fetch(
          "https://tonapi.io/v2/nfts/collections?limit=6",
          { headers }
        );
          ...
          <div className="screen">
            ...
            <GlassCard accent="#a78bfa">
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                ...
                <span className="cap" style={{ display:"flex", alignItems:"center", gap:4 }}>
                  Via
                  <img src={TonIcon} alt="TON" style={{ width:11, height:11, objectFit:"contain", opacity:0.6 }} />
                  TON
                </span>
              </div>
                ...
                <div className="nft-grid">
                  {nfts.map((col) => (
                    ...
                    >
                      ...
                      {col.ownerCount && (
                        <span className="nft-floor">{col.ownerCount.toLocaleString()} owners</span>
                      )}
                    </a>
                  ))}
                </div>
